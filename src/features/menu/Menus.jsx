...
import { addItem, decreaseItem } from '../cart/cartSlice';

export default function Menus({ selectedCategory }) {
  ...
  const menuCategories = useMemo(() => {
    ...
    if (!selectedCategory || selectedCategory === 'All') return categories;
  ...
  return (
    <section className="px-4 lg:px-10 py-10 bg-background-light dark:bg-background-dark min-h-screen">
      ...
      <div className="mx-auto w-full">
        {menuCategories.length === 0 && !loading ? (
                    ...
                    <div className="px-2 pb-2">
                      ...
                      <div className="flex items-center justify-between mt-auto">
                        ...
                        <div className="flex items-center gap-3 bg-red-600 rounded-full px-1 py-1 shadow-lg shadow-red-600/30">
                          <button
                            onClick={() => dispatch(decreaseItem(menu.id))}
